...
public interface TbStudyrecordMapper {
	...
	public Double findTimeLength(@Param("stuId")Integer stuId, @Param("subId")Integer subId);
	public int addTimeLength(@Param("stuId")Integer stuId, @Param("subId")Integer subId,@Param("studyLength")Double studyLength);
	public Double sumTimeLength(@Param("stuId")Integer stuId, @Param("subId")Integer subId);

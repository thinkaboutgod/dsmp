    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">友情链接修改/新增</h4>
            </div>
				<div class="modal-body">
					<div class="form-horizontal">
						<input id="parId" type="hidden" >
						<div class="form-group">
							<label for="holaTitle" class="col-sm-2 control-label">链接名称：</label>
							<div class="col-sm-10">
								<input class="form-control" id="holTitle" type="text" >
							</div>
						</div>
						<div class="form-group">
							<label for="holPath" class="col-sm-2 control-label">链接地址：</label>
							<div class="col-sm-10">
								<input class="form-control" id="holPath" type="text">
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src=<%=path+"/js/plateform_blogroll.js"%> ></script>
</html>

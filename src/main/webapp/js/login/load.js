! function(t, r) {
	"object" == typeof exports && "object" == typeof module ? module.exports = r() : "function" == typeof define && define
		.amd ? define([], r) : "object" == typeof exports ? exports.initNECaptcha = r() : t.initNECaptcha = r()
}(this, function() {
	return function(t) {
		function r(e) {
		...
		function o(t, r, n) {
			this.name = "CaptchaError", this.code = t, this.message = t + ("(" + v[t] + ")") + (r ? " - " + r : ""), Error.captureStackTrace ?
				Error.captureStackTrace(this, this.constructor) : this.stack = (new Error).stack, this.data = n || {}
		}
		var i, a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
			...
			d = 504,
			y = 1e3,
			v = (i = {}, n(i, u, "script error"), n(i, s, "business error"), n(i, l, "request error"), n(i, f,
				"request api error"), n(i, p, "request script error"), n(i, h, "request img error"), n(i, d,
				"request timeout error"), n(i, y, "unknown error"), i);
		e(o, Error), o[c].toString = function() {
				var t = String(this.stack);
				return 0 === t.indexOf("CaptchaError:") ? t : this.name + ": " + this.message + (t ? "\n    " + t : "")
			}, o.set = function(t, r) {
				"number" == typeof t && "string" == typeof r && (v[t] = r), "object" === ("undefined" == typeof t ? "undefined" :
					a(t)) && t && Object.assign(v, t)
			}, o.get = function(t) {
				return v[t]
			}, o.remove = function(t) {
				String(t) in v && delete v[t]
			}, r = t.exports = o, r.SCRIPT_ERROR = u, r.BUSINESS_ERROR = s, r.REQUEST_ERROR = l, r.REQUEST_API_ERROR = f, r.REQUEST_SCRIPT_ERROR =
			p, r.REQUEST_IMG_ERROR = h, r.REQUEST_TIMEOUT_ERROR = d, r.UNKNOWN_ERROR = y
	}, function(t, r, n) {
		function e(t, r) {
			var n = {};
		...
		var o = Object.assign || function(t) {
			...
			d = function(t) {
				this.id = t.id || "resource_" + l++, this.type = t.type || "script", this.url = t.url || "", this.payload = t.payload,
					this.timeout = t.timeout || 6e3, this.cacheTime = t.cacheTime ? parseInt(t.cacheTime, 10) : 0, this.detectKey =
					t.detectKey || "", this._options = t, a.call(this), this.load(), this.setTimeout()
			};
		...
		Object.assign(n.prototype, {
			then: function(t, r) {
				...
				return n(t) && this._fullfilledCallback.push(t), n(r) && this._rejectedCallback.push(r), this._state !== i &&
					this._emit(this._state), this
			},
			"catch": function(t) {
			...
			resolve: function(t) {
				this._state === i && (t instanceof Error ? this._state = c : this._state = a, this._arg = t, this._emit(this
					._state))
			},
			_emit: function(t) {
				var r = this;
		...
		t.exports = function(t) {
			...
			return u && (u = u.replace(/^\/*|\/+/g, "/")), l && (l = l.replace(/^\??/, "?")), p && (p = p.replace(/^#?/,
				"#")), n + o + a + u + l + p
		}
	}, function(t, r) {
		r.CAPTCHA_TYPE = {
		...
		t.exports = function(t) {
			...
			for (var n = 0, e = r.length; n < e; n++)
				if (new RegExp("/" + r[n] + "\\.(\\S*?\\.min\\.)?js").test(t)) return o[r[n]];
			return ""
		}
	}, function(t, r) {
		var n = {}.toString,
			e = {
				...
				getObjKey: function(t, r) {
					for (var n in t)
						if (t.hasOwnProperty(n) && t[n] === r) return n
				},
				typeOf: function(t) {
				...
				log: function(t, r) {
					...
					return "string" == typeof t && ~n.indexOf(t) ? void(console && console[t]("[NECaptcha] " + r)) : void e.error(
						'util.log(type, msg): "type" must be one string of ' + n.toString())
				},
				warn: function(t) {
					e.log("warn", t)
				},
				...
				template: function(t, r) {
					var n = function(t) {
						...
						a = new Function("obj", "var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('" + t.replace(
							/[\r\t\n]/g, " ").replace(i, "\t").split("'").join("\\'").split("\t").join("'").replace(o.interpolate,
							"',$1,'").split(o.start).join("');").split(o.end).join("p.push('") + "');}return p.join('');");
					return r ? a(r) : a
				},
				uuid: function a(t, r) {
					var n = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
						...
						e = void 0;
					if (r = r || n.length, t)
						for (e = 0; e < t; e++) a[e] = n[0 | Math.random() * r];
					else {
						var o = void 0;
						for (a[8] = a[13] = a[18] = a[23] = "-", a[14] = "4", e = 0; e < 36; e++) a[e] || (o = 0 | 16 * Math.random(),
							a[e] = n[19 === e ? 3 & o | 8 : o])
					}
					return a.join("")
				},
				...
				encodeUrlParams: function(t) {
					var r = [];
					for (var n in t) t.hasOwnProperty(n) && r.push(window.encodeURIComponent(n) + "=" + window.encodeURIComponent(
						t[n]));
					return r.join("&")
				}
			};
		...
		t.exports = function(t, r, n) {
			...
			var R = e + "://only-d-" + y(32) + "-" + (new Date).valueOf() + ".nstool.netease.com/ip.js";
			return h.script({
				url: R,
				timeout: l,
				...
				Object.assign(O, m), _(g, O, function(t, r) {
					if (t || r.error) {
		...
		function e(t, r, e, a) {
			...
			"object" === ("undefined" == typeof e ? "undefined" : o(e)) && (a = e, e = null), "function" == typeof r && (e =
				r, r = null), a || (a = {});
			...
			return v && (f = setTimeout(function() {
				...
				c(), e && e(null, t)
			}, r && (t = t.split("?")[0]), t += (~t.indexOf("?") ? "&" : "?") + s(r) + "&" + y + "=" + m(d), t = t.replace(
				"?&", "?"), l = document.createElement("script"), l.type = "text/javascript", l.src = t, g.parentNode.insertBefore(
				l, g), u
		}
		...
		function e(t, r, n) {
			...
			!y[m] && (y[m] = g), g.then(function() {
				...
				y[m] = null, n(new u(s, t.message, t.data))
			})
		}
		var o = n(16),
			i = n(2),
		...
		function o(t) {
			s.call(this), e(t.captchaConfig, 'option "captchaConfig" is required.'), e(t.cache,
					'option "cache" is required.'), this._captchaConfig = t.captchaConfig, this._captchaHooks = t.captchaHooks,
				this._cache = t.cache, this._error = null
		}
					...
					E = function() {
						g(d, y, function(n, e) {
							...
							var a = function(t) {
									...
									null == n.apiServer && (n.apiServer = t.apiServer), null == n.staticServer && (n.staticServer = t.staticServers),
										n.theme = t.theme, n.acConfig = t.ac, n.__serverConfig__ = t
								},
								c = e.data;
							_ && l && (c = Object.assign({}, c, l)), a(c), r.emit("after-config", r._captchaConfig.__serverConfig__)
		...
		Object.keys || (Object.keys = function() {
			...
			var t = Object.prototype.hasOwnProperty,
				...
				e = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable",
					"constructor"
				],
				o = e.length;
			return function(i) {
				if ("function" != typeof i && ("object" !== ("undefined" == typeof i ? "undefined" : n(i)) || null === i))
					throw new TypeError("Object.keys called on non-object");
				var a, c, u = [];
				for (a in i) t.call(i, a) && u.push(a);
				if (r)
					for (c = 0; c < o; c++) t.call(i, e[c]) && u.push(e[c]);
				return u
			}
		}())
	}, function(t, r) {
		...
		t.exports = function(t, r, i) {
			...
			"function" == typeof r && (i = r, r = {}), r = r || {}, i = i || function() {}, c.type = r.type ||
				"text/javascript", c.charset = r.charset || "utf8", c.async = !("async" in r) || !!r.async, c.src = t, r.attrs &&
				n(c, r.attrs), r.text && (c.text = "" + r.text);
